...
export type GetAllMembersQuery = { __typename: 'Query', memberships: Array<{ __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, invitedBy?: { __typename: 'Membership', id: string, handle: string, roles: Array<{ __typename: 'Worker', createdAt: any, group: { __typename: 'WorkingGroup', id: string, createdAt: any, name: string } }>, metadata: { __typename: 'MemberMetadata', avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null } } | null, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }>, stakingaccountaddedeventmember?: Array<{ __typename: 'StakingAccountAddedEvent', createdAt: any, inBlock: number, network: Types.Network, account: string }> | null, entry: { __typename: 'MembershipEntryGenesis', phantom?: number | null } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: { __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network } | null } | { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: { __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network } | null } }> };
...
export type GetMemberInvitedEventsQuery = { __typename: 'Query', memberInvitedEvents: Array<{ __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network }> };
...
export const GetMemberInvitedEventsDocument = gql`
  ...
  memberInvitedEvents(
    where: {controllerAccount_eq: $lockAccount}
 ...
 * });
 */
export function useGetMemberInvitedEventsQuery(baseOptions?: Apollo.QueryHookOptions<GetMemberInvitedEventsQuery, GetMemberInvitedEventsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMemberInvitedEventsQuery, GetMemberInvitedEventsQueryVariables>(GetMemberInvitedEventsDocument, options);
      }
export function useGetMemberInvitedEventsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMemberInvitedEventsQuery, GetMemberInvitedEventsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMemberInvitedEventsQuery, GetMemberInvitedEventsQueryVariables>(GetMemberInvitedEventsDocument, options);
        }
...
export type GetMemberInvitedEventsQueryResult = Apollo.QueryResult<GetMemberInvitedEventsQuery, GetMemberInvitedEventsQueryVariables>;