...
export type GetQueryNodeStateSubscription = { __typename: 'Subscription', stateSubscription: { __typename: 'ProcessorState', chainHead: string, indexerHead: string, lastCompleteBlock: string, lastProcessedEvent: string } };
