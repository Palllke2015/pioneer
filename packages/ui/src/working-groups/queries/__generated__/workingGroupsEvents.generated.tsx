...
export type BudgetSpendingActivityEventFieldsFragment = { __typename: 'BudgetSpendingEvent', id: string, createdAt: any, amount: string, group: { __typename: 'WorkingGroup', name: string } };

export type StakeDecreasedEventFieldsFragment = { __typename: 'StakeDecreasedEvent', id: string, createdAt: any, amount: string, worker: { __typename: 'Worker', membership: { __typename: 'Membership', id: string, handle: string } } };

export type StakeIncreasedEventFieldsFragment = { __typename: 'StakeIncreasedEvent', id: string, createdAt: any, amount: string, worker: { __typename: 'Worker', membership: { __typename: 'Membership', id: string, handle: string } } };
...
export type BudgetSetEventFieldsFragment = { __typename: 'BudgetSetEvent', id: string, createdAt: any, newBudget: string, group: { __typename: 'WorkingGroup', name: string } };
...
export type WorkerRewardAmountUpdatedEventFragment = { __typename: 'WorkerRewardAmountUpdatedEvent', id: string, createdAt: any, newRewardPerBlock: string };
