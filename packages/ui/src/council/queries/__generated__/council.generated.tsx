...
export type PastCouncilBudgetSetEventFieldsFragment = { __typename: 'BudgetSetEvent', newBudget: string, groupId: string };

export type PastCouncilRewardPaidEventFieldsFragment = { __typename: 'RewardPaidEvent', groupId: string, amount: string };

export type PastCouncilNewMissedRewardLevelReachedEventFieldsFragment = { __typename: 'NewMissedRewardLevelReachedEvent', groupId: string, workerId: string, newMissedRewardAmount: string };
...
export type PastCouncilDetailedFieldsFragment = { __typename: 'ElectedCouncil', id: string, endedAtBlock?: number | null, endedAtNetwork?: Types.Network | null, endedAtTime?: any | null, councilMembers: Array<{ __typename: 'CouncilMember', accumulatedReward: string, unpaidReward: string }> };

export type ElectionCandidateFieldsFragment = { __typename: 'Candidate', id: string, stake: string, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }>, stakingaccountaddedeventmember?: Array<{ __typename: 'StakingAccountAddedEvent', createdAt: any, inBlock: number, network: Types.Network, account: string }> | null, entry: { __typename: 'MembershipEntryGenesis', phantom?: number | null } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: { __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network } | null } | { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: { __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network } | null } }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } };
...
export type PastElectionRoundFieldsFragment = { __typename: 'ElectionRound', id: string, cycleId: number, endedAtBlock?: number | null, endedAtTime?: any | null, endedAtNetwork?: Types.Network | null, candidates: Array<{ __typename: 'Candidate', stake: string }>, castVotes: Array<{ __typename: 'CastVote', voteForId?: string | null }> };

export type PastElectionRoundDetailedFieldsFragment = { __typename: 'ElectionRound', id: string, cycleId: number, endedAtBlock?: number | null, endedAtTime?: any | null, endedAtNetwork?: Types.Network | null, candidates: Array<{ __typename: 'Candidate', stake: string, id: string, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }>, stakingaccountaddedeventmember?: Array<{ __typename: 'StakingAccountAddedEvent', createdAt: any, inBlock: number, network: Types.Network, account: string }> | null, entry: { __typename: 'MembershipEntryGenesis', phantom?: number | null } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: { __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network } | null } | { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: { __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network } | null } }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } }>, castVotes: Array<{ __typename: 'CastVote', stake: string, stakeLocked: boolean, voteForId?: string | null, castBy: string }> };

export type ElectionCandidateDetailedFieldsFragment = { __typename: 'Candidate', stakingAccountId: string, rewardAccountId: string, id: string, stake: string, status: Types.CandidacyStatus, electionRound: { __typename: 'ElectionRound', cycleId: number, isFinished: boolean }, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }>, stakingaccountaddedeventmember?: Array<{ __typename: 'StakingAccountAddedEvent', createdAt: any, inBlock: number, network: Types.Network, account: string }> | null, entry: { __typename: 'MembershipEntryGenesis', phantom?: number | null } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: { __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network } | null } | { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: { __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network } | null } }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } };

export type CastVoteFieldsFragment = { __typename: 'CastVote', id: string, stake: string, stakeLocked: boolean, castBy: string, commitment: string, voteFor?: { __typename: 'Candidate', id: string, stake: string, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }>, stakingaccountaddedeventmember?: Array<{ __typename: 'StakingAccountAddedEvent', createdAt: any, inBlock: number, network: Types.Network, account: string }> | null, entry: { __typename: 'MembershipEntryGenesis', phantom?: number | null } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: { __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network } | null } | { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: { __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network } | null } }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } } | null, electionRound: { __typename: 'ElectionRound', cycleId: number }, castEvent?: Array<{ __typename: 'VoteCastEvent', inBlock: number, network: Types.Network, createdAt: any }> | null };

export type CouncilSpendingEventFieldsFragment = { __typename: 'BudgetSpendingEvent', amount: string, type?: Types.EventTypeOptions | null };

export type FundingRequestApprovedFragment = { __typename: 'ProposalExecutedEvent', proposal: { __typename: 'Proposal', details: { __typename: 'AmendConstitutionProposalDetails' } | { __typename: 'CancelWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'CreateBlogPostProposalDetails' } | { __typename: 'CreateWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'DecreaseWorkingGroupLeadStakeProposalDetails' } | { __typename: 'EditBlogPostProposalDetails' } | { __typename: 'FillWorkingGroupLeadOpeningProposalDetails' } | { __typename: 'FundingRequestProposalDetails', destinationsList?: { __typename: 'FundingRequestDestinationsList', destinations: Array<{ __typename: 'FundingRequestDestination', amount: string, account: string }> } | null } | { __typename: 'LockBlogPostProposalDetails' } | { __typename: 'RuntimeUpgradeProposalDetails' } | { __typename: 'SetCouncilBudgetIncrementProposalDetails' } | { __typename: 'SetCouncilorRewardProposalDetails' } | { __typename: 'SetInitialInvitationBalanceProposalDetails' } | { __typename: 'SetInitialInvitationCountProposalDetails' } | { __typename: 'SetMaxValidatorCountProposalDetails' } | { __typename: 'SetMembershipLeadInvitationQuotaProposalDetails' } | { __typename: 'SetMembershipPriceProposalDetails' } | { __typename: 'SetReferralCutProposalDetails' } | { __typename: 'SetWorkingGroupLeadRewardProposalDetails' } | { __typename: 'SignalProposalDetails' } | { __typename: 'SlashWorkingGroupLeadProposalDetails' } | { __typename: 'TerminateWorkingGroupLeadProposalDetails' } | { __typename: 'UnlockBlogPostProposalDetails' } | { __typename: 'UpdateWorkingGroupBudgetProposalDetails' } | { __typename: 'VetoProposalDetails' } } };
...
export type GetCouncilorVoterStakeQuery = { __typename: 'Query', candidates: Array<{ __typename: 'Candidate', memberId: string, votesReceived: Array<{ __typename: 'CastVote', stake: string }> }> };
...
export type GetPastCouncilWorkingGroupsQuery = { __typename: 'Query', workingGroups: Array<{ __typename: 'WorkingGroup', id: string, name: string }>, budgetSetEvents: Array<{ __typename: 'BudgetSetEvent', newBudget: string, groupId: string }>, rewardPaidEvents: Array<{ __typename: 'RewardPaidEvent', groupId: string, amount: string }>, newMissedRewardLevelReachedEvents: Array<{ __typename: 'NewMissedRewardLevelReachedEvent', groupId: string, workerId: string, newMissedRewardAmount: string }> };
...
export type GetCouncilVotesQuery = { __typename: 'Query', castVotes: Array<{ __typename: 'CastVote', id: string, stake: string, stakeLocked: boolean, castBy: string, commitment: string, voteFor?: { __typename: 'Candidate', id: string, stake: string, status: Types.CandidacyStatus, stakingAccountId: string, member: { __typename: 'Membership', id: string, rootAccount: string, controllerAccount: string, boundAccounts: Array<string>, handle: string, isVerified: boolean, isFoundingMember: boolean, isCouncilMember: boolean, inviteCount: number, createdAt: any, metadata: { __typename: 'MemberMetadata', name?: string | null, about?: string | null, avatar?: { __typename: 'AvatarObject' } | { __typename: 'AvatarUri', avatarUri: string } | null }, roles: Array<{ __typename: 'Worker', id: string, createdAt: any, isLead: boolean, group: { __typename: 'WorkingGroup', name: string } }>, stakingaccountaddedeventmember?: Array<{ __typename: 'StakingAccountAddedEvent', createdAt: any, inBlock: number, network: Types.Network, account: string }> | null, entry: { __typename: 'MembershipEntryGenesis', phantom?: number | null } | { __typename: 'MembershipEntryInvited', memberInvitedEvent?: { __typename: 'MemberInvitedEvent', createdAt: any, inBlock: number, network: Types.Network } | null } | { __typename: 'MembershipEntryPaid', membershipBoughtEvent?: { __typename: 'MembershipBoughtEvent', createdAt: any, inBlock: number, network: Types.Network } | null } }, noteMetadata: { __typename: 'CandidacyNoteMetadata', header?: string | null, bulletPoints: Array<string>, bannerImageUri?: string | null, description?: string | null } } | null, electionRound: { __typename: 'ElectionRound', cycleId: number }, castEvent?: Array<{ __typename: 'VoteCastEvent', inBlock: number, network: Types.Network, createdAt: any }> | null }> };
...
export type GetCouncilorElectionEventQuery = { __typename: 'Query', councilMembers: Array<{ __typename: 'CouncilMember', electedInCouncil: { __typename: 'ElectedCouncil', id: string, electedAtBlock: number, electedAtTime: any, electedAtNetwork: Types.Network } }> };
...
export const GetCouncilorElectionEventDocument = gql`
  ...
  councilMembers(
    where: {stakingAccountId_eq: $lockAccount}
    orderBy: [createdAt_DESC]
    limit: 1
  ) {
    electedInCouncil {
 ...
 * });
 */
export function useGetCouncilorElectionEventQuery(baseOptions?: Apollo.QueryHookOptions<GetCouncilorElectionEventQuery, GetCouncilorElectionEventQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCouncilorElectionEventQuery, GetCouncilorElectionEventQueryVariables>(GetCouncilorElectionEventDocument, options);
      }
export function useGetCouncilorElectionEventLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCouncilorElectionEventQuery, GetCouncilorElectionEventQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCouncilorElectionEventQuery, GetCouncilorElectionEventQueryVariables>(GetCouncilorElectionEventDocument, options);
        }
...
export type GetCouncilorElectionEventQueryResult = Apollo.QueryResult<GetCouncilorElectionEventQuery, GetCouncilorElectionEventQueryVariables>;